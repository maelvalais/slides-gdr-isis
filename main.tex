...
\makebox[\linewidth]{\includegraphics[width=0.8\linewidth]{figures/0-intro-parcimonie/representation-parcimonieuse.pdf}}
\end{figure}
\end{frame}

\begin{frame}{Exemples d'application des représentations parcimonieuses}
\begin{itemize}
\item \alert{Débruitage}
	\begin{figure}\centering
	\makebox[\linewidth]{\includegraphics[width=1.1\linewidth]{figures/0-intro-parcimonie/exple-denoise.pdf}}
	\end{figure}
\item \alert{reconnaissance d'images}
\item \alert{compression}
\end{itemize}
\end{frame}
...
Deux grands types de dictionnaires : \alert{générique} et \alert{appris}
...
\begin{figure}\centering
\makebox[\linewidth]{\includegraphics[width=1.1\linewidth]{figures/1-intro-modele/tree.pdf}}
\end{figure}
