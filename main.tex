...
\end{itemize}
\begin{figure}\centering
\makebox[\linewidth]{\includegraphics[width=1.1\linewidth]{figures/tree-learn-setup/inputs.pdf}}
\end{figure}
\end{frame}
...
\begin{figure}\centering
\makebox[\linewidth]{\includegraphics[width=1.1\linewidth]{figures/tree-learn-setup/outputs.pdf}}
\end{figure}
\end{frame}
