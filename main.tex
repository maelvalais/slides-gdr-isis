...
\end{itemize}
\begin{figure}\centering
\makebox[\linewidth]{\includegraphics[width=1.1\linewidth]{figures/tree-learn-setup/intro-inputs.pdf}}
\end{figure}
\end{frame}
...
\begin{figure}\centering
\makebox[\linewidth]{\includegraphics[width=1.1\linewidth]{figures/tree-learn-setup/intro-outputs.pdf}}
\end{figure}
\end{frame}
...
\begin{figure}\centering
    \makebox[\linewidth]{\includegraphics[width=1.2\linewidth]{figures/check-gradient/branche-setup.pdf}}
\end{figure}
\end{frame}

\begin{frame}{Gain versus gradient}
\begin{figure}\centering
    \makebox[\linewidth]{\includegraphics[width=1.1\linewidth]{figures/check-gradient/gradient-vs-gain.pdf}}
\end{figure}
\end{frame}

\begin{frame}{Après ajout}
\begin{figure}\centering
    \makebox[\linewidth]{\includegraphics[width=1.0\linewidth]{figures/check-gradient/apres-ajout.pdf}}
\end{figure}
\end{frame}

\begin{frame}{Explication expériences sur un arbre}
\begin{figure}\centering
    \makebox[\linewidth]{\includegraphics[width=1.0\linewidth]{figures/tree-learn-setup/learn-inputs.pdf}}
\end{figure}
\end{frame}

\begin{frame}{Détail algorithme OMP-PALMTREE}
\begin{figure}\centering
    \makebox[\linewidth]{\includegraphics[width=1.1\linewidth]{figures/tree-learn-setup/algo-omp-palmtree.pdf}}
\end{figure}
\end{frame}

\begin{frame}{Problème des supports dispersés}
\begin{figure}\centering
    \makebox[\linewidth]{\includegraphics[width=1.1\linewidth]{figures/tree-learn-setup/scattered-tree.pdf}}
\end{figure}
\end{frame}

\begin{frame}{Ajout d'un à priori sur les supports}
\begin{figure}\centering
    \makebox[\linewidth]{\includegraphics[width=1.1\linewidth]{figures/tree-learn-setup/scattered-explication.pdf}}
\end{figure}
\end{frame}
